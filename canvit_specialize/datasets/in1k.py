...
Data files live in canvit_specialize/data/in1k/:
  - real.json: ImageNet-ReAL multi-labels (Beyer et al. 2020)
  - classes.json: 1000 IN1K synset descriptions
"""
...
_DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "in1k"
