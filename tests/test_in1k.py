"""Tests for IN1K dataset utilities, loss functions, eval, and naming."""
...
from canvit_specialize.training.in1k.loss import sigmoid_loss, softmax_loss
from canvit_specialize.training.in1k.naming import model_name_from_repo
...
def test_evaluate_overfit():
    ...
    result = evaluate(model, features, labels, batch_size=8, loss_fn=softmax_loss)
